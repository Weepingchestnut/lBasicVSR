...
import lmmcv
import torch
from lmmcv.runner import HOOKS, Hook
from lmmcv.runner.dist_utils import master_only
...
class VisualizationHook(Hook):
    ...
    def __init__(self,
                 ...
                 nrow=1,
                 padding=4):
        assert lmmcv.is_list_of(res_name_list, str)
        ...
        lmmcv.mkdir_or_exist(self.output_dir)
