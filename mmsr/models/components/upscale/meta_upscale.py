...
class MetaUpscale(nn.Module):
    ...
    def forward(self, x, scale):
        ...
        # weight prediction
        local_weight = self.meta_block(scale_coord_map.view(scale_coord_map.size(1), -1))   # (outH*outW, outC*inC*kernel_size*kernel_size)
        ...
        out = out.contiguous().view(N, C, round(H*scale), round(W*scale))
