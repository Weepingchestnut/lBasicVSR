...
from mmsr.core import tensor2img
...
class LIIF(BasicRestorer):
    ...
    def __init__(self,
        ...
        # norm
        rgb_mean = torch.FloatTensor(rgb_mean)          # tensor([0.5000, 0.5000, 0.5000])
        rgb_std = torch.FloatTensor(rgb_std)            # tensor([0.5000, 0.5000, 0.5000])
        self.lq_mean = rgb_mean.view(1, -1, 1, 1)       # torch.Size([1, 3, 1, 1])
        self.lq_std = rgb_std.view(1, -1, 1, 1)         # torch.Size([1, 3, 1, 1])
        self.gt_mean = rgb_mean.view(1, 1, -1)          # torch.Size([1, 1, 3])
        self.gt_std = rgb_std.view(1, 1, -1)            # torch.Size([1, 1, 3])
    ...
    def forward_test(self,
        ...
        if save_image:
            ...
            lmmcv.imwrite(tensor2img(pred), save_path)
